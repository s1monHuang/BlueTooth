...
// end copy from AFURLResponseSerialization.m


@implementation AppResponseSerializer
...
+ (instancetype)serializerWithReadingOptions:(NSJSONReadingOptions)readingOptions {
    AppResponseSerializer *serializer = [[self alloc] init];
...
// modify by jimple 加入 text/plain
